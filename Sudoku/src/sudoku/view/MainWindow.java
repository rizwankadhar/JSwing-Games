...
public class MainWindow extends JFrame {
    ...
    private void showExitConfirmation() {
        ...
        int n = JOptionPane.showConfirmDialog(this,
                "Do you wanna quit without save?",
    ...
    private final Action saveAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            FileChooser chooser = new FileChooser("Save");
    ...
    private final Action loadAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            FileChooser chooser = new FileChooser("Load");
            File chosenFile = chooser.open();
            if (chosenFile != null) {
                try {
    ...
    private final Action startNewGameAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(MainWindow.this,
                        "An error occured while loading a new game from file.");
            }
    ...
    private final Action checkAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (errors == 0) {
                ...
                JOptionPane.showMessageDialog(MainWindow.this,
                        "Sorry, but your solution is not complete. Wrong/empty cells: " + errors);
            }
    ...
    private void resetGridAndTimers() {
        ...
        moveChecker = new Timer(5000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                stopTimers();
                JOptionPane.showMessageDialog(MainWindow.this, "5 seconds, and still nothing!");
                startTimers();
            }
    ...
    private void updateTimeLabel() {
        if (model == null) {
            timeLabel.setText("No game activity.");
        } else {
            timeLabel.setText("Elapsed time: " + model.getTime() + " sec.");
        }
    }
